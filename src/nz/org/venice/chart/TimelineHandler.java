...
/**
 * A class that contains the toolbar implemented to handle the timeline in a
 * chart view This adds a toolbar with a JScrollbar component to the chart and
 * handles the events To move the time being viewed when zoomed in
 * 
...
class TimelineHandler implements ChangeListener, MouseWheelListener {
	...
	// Call this method when the timeline was modified (zoomed in/out) to
	// recalculate values
