...
public class MACDGraphUI implements GraphUI {
	...
	private void buildPanel() {
		...
		periodFirstAverageTextField = GridBagHelper.addTextRow(panelTextBoxes, Locale.getString("PERIOD_FIRST_AVERAGE"),
				"", layout, c, 8);
		smoothingConstantFirstAverageTextField = GridBagHelper.addTextRow(panelTextBoxes,
				Locale.getString("SMOOTHING_CONSTANT_FIRST_AVERAGE"), "", layout, c, 8);
		periodSecondAverageTextField = GridBagHelper.addTextRow(panelTextBoxes,
				Locale.getString("PERIOD_SECOND_AVERAGE"), "", layout, c, 8);
		smoothingConstantSecondAverageTextField = GridBagHelper.addTextRow(panelTextBoxes,
				Locale.getString("SMOOTHING_CONSTANT_SECOND_AVERAGE"), "", layout, c, 8);
	...
	public String checkSettings(HashMap settings) {
		...
		if (smoothingConstant < MINIMUM_SMOOTHING_CONSTANT || smoothingConstant > MAXIMUM_SMOOTHING_CONSTANT)
			return Locale.getString("ERROR_SMOOTHING_CONSTANT", MINIMUM_SMOOTHING_CONSTANT, MAXIMUM_SMOOTHING_CONSTANT);
	...
	/**
	 * Retrieve the average type (EMA or SMA) from the settings hashmap. If the
	 * hashmap is empty, then return the default average type (i.e. EMA).
	 *
	...
	/**
	 * Retrieve the period of the first average from the settings hashmap. If the
	 * hashmap is empty, then return the default.
	 *
	 * @param settings the settings
	 * @return the period
	 */
	...
	/**
	 * Retrieve the smoothing constant of the first average from the settings
	 * hashmap. If the hashmap is empty, then return the default smoothing constant.
	 *
	 * @param settings the settings
	...
	/**
	 * Retrieve the period of the second average from the settings hashmap. If the
	 * hashmap is empty, then return the default.
	 *
	 * @param settings the settings
	 * @return the period
	...
	/**
	 * Retrieve the smoothing constant of the second average from the settings
	 * hashmap. If the hashmap is empty, then return the default smoothing constant.
	 *
	 * @param settings the settings
	 * @return the smoothign constant
