...
abstract public class AbstractGraph implements Graph {
	...
	/**
	 * Set the default values to the ones provided by this <code>GraphSource</code>.
	 *
	...
	/**
	 * Get underlying <code>GraphSource</code> we are using for default values.
	 *
	 ...
	 *
	 * @param value y value
	 * @return the Y label text that the default <code>GraphSource</code> would
	 *         display
	 */
	...
	/**
	 * Returns the graph's user interface. The default action is to return
	 * <code>null</code> which indicates that the graph does not have a user
	 * interface. If the graph does have a user interface then it should override
	 * this method.
	 *
