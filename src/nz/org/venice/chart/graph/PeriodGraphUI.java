...
/**
 * A generic graph user interface that queries the user for a period. Since many
 * of the graphs have only a single setting, the period, it makes sense for them
 * to share a user interface.
 *
