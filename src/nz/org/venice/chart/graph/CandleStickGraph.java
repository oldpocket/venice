...
/**
 * Candlestick graph. This graph draws a single vertical line between the day
 * low and the day high values and draws a candle between the day open and the
 * day close.
 *
...
public class CandleStickGraph extends AbstractGraph {
	...
	public void render(Graphics g, Color c, int xoffset, int yoffset, double horizontalScale, double verticalScale,
		...
		while (iterator.hasNext()) {
			...
			if (dayLowY != null && dayHighY != null && dayCloseY != null && dayOpen != null) {
				...
				if (closeY > openY) { // red candle : open higher than close
					...
					g.drawLine(xCoordinate + halfbarWidth + 1 + halfBlankWidth, lowY,
							xCoordinate + halfbarWidth + 1 + halfBlankWidth, closeY);
					g.drawLine(xCoordinate + halfbarWidth + 1 + halfBlankWidth, openY,
					...
					g.drawLine(xCoordinate + halfbarWidth + 1 + halfBlankWidth, lowY,
							xCoordinate + halfbarWidth + 1 + halfBlankWidth, openY);
					...
					g.drawLine(xCoordinate + halfbarWidth + 1 + halfBlankWidth, lowY,
							xCoordinate + halfbarWidth + 1 + halfBlankWidth, highY);
					g.drawLine(xCoordinate + halfBlankWidth, openY, xCoordinate + halfbarWidth * 2 + 1 + halfBlankWidth,
							openY);
