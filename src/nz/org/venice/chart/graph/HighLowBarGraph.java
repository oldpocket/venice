...
/**
 * High low bar graph. This graph draws a single vertical line between the day
 * low and the day high values and draws a single horizontal bars at the day
 * close.
 */
...
//		g.drawLine(xCoordinate, lowY, xCoordinate, highY);
				g.drawLine(xCoordinate + halfbarWidth + 1 + halfBlankWidth, lowY,
						xCoordinate + halfbarWidth + 1 + halfBlankWidth, highY);// bryan
...
//			   closeY);
				g.drawLine(xCoordinate + halfbarWidth + 1 + halfBlankWidth, closeY,
						(int) (xCoordinate + DAY_CLOSE_BAR_WIDTH * horizontalScale), closeY);
