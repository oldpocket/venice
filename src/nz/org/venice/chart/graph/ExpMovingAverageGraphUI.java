...
public class ExpMovingAverageGraphUI implements IGraphUI {
	...
	private void buildPanel() {
		...
		smoothingConstantTextField = GridBagHelper.addTextRow(panel, Locale.getString("SMOOTHING_CONSTANT"), "", layout,
				c, 8);
	}
	...
	/**
	 * Retrieve the smoothing constant from the settings hashmap. If the hashmap is
	 * empty, then return the default smoothing constant.
	 *
	 * @param settings the settings
