...
/**
 * Provides a Portfolio graph source. This class allows portfolios to be
 * graphed.
 *
...
public class PortfolioGraphSource implements GraphSource {
	 ...
	 * allows you to graph the market value of the portfolio, the profit/loss made
	 * by the portfolio, and the value of the portfolio's cash or share holdings.
	 *
	 * @param portfolio   the portfolio to graph
	 * @param quoteBundle quote bundle containing all the necessary quotes to
	 *                    calculate the portfolio value for every day
	 * @param mode        {@link #MARKET_VALUE} for the total market value of the
	 *                    portfolio; {@link #RETURN_VALUE} for the return moade;
	 *                    {@link #CASH_VALUE} for the cash value of the portfolio;
	 *                    {@link #STOCKS_HELD} for the number of stocks held in the
	 *                    portfolio; or {@link #SHARE_VALUE} for the share value of
	 *                    the portfolio.
	 */
	...
	/**
	 * Create a graph source to graph the value of a single account in the
	 * portfolio.
	 *
	 * @param portfolio   the portfolio to graph
	 * @param quoteBundle quote bundle containing all the necessary quotes to
	...
	public double[] getAcceptableMajorDeltas() {
		if (mode == STOCKS_HELD) {
			double[] major = { 1D, 10D, 100D, 1000D, // 1T
