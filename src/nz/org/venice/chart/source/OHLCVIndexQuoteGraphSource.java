...
/**
 * Provides a <code>EODQuoteBundle</code> index source. This class allows index
 * sources for day Open, High, Low, Close and Volume (OHLCV).
 */
public class OHLCVIndexQuoteGraphSource implements IGraphSource {
