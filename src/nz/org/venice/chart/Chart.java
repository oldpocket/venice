...
/**
 * New swing component that allows creation of charts. This charting component
 * supports graphing levels and also highlighting of a graph region.
 *
 * @see ChartModule
 */
public class Chart extends JComponent implements MouseListener {
	...
	/**
	 * Chart a new graph at the given level. If the chart does not contain the
	 * level, create a new one.
	 *
	...
	/**
	 * Remove the graph from the chart. If the graph was an only member of its
	 * level, then the level will also be removed.
	 *
	 ...
	 *
	 * @return A <code>Vector</code> where each element represents a a graph level.
	 *         Each element in the <code>Vector</code> is another
	 *         <code>Vector</code> containing the graphs at that level.
	 */
	...
	/**
	 * Return the colour that the given graph will be drawn. Note that the graph may
	...
	/**
	 * Sets the start X point of the highlighted region. Also resets the end point
	 * of the highlighted region to the start point. This creates a highlighted
	 * region 1 pixel thick.
	 *
	...
	/**
	 * Sets the end point of a drawn line. The line will now stretch from the start
	 * to the end point.
	 *
	...
	public void setDrawnLineStart(Comparable dataX, Double dataY, Integer absY) {
		...
		drawnElements.createNewLine(new Coordinate(dataX, dataY, absY, level));
		repaint();
	}
	...
	public void setDrawnLineEnd(Comparable dataX, Double dataY, Integer absY) {
	...
	/**
	 * Generate the equation of the line passing through points specified by index,
	 * and return the difference between those points and x,y
	 *
	 * @param x     the x coordinate
	 * @param y     the y coordinate
	...
	/**
	 * Find the line intersecting at x,y. Return the coordinate of the end point
	...
	/**
	 * 
	 * Set the viewing orientation of the chart. Normal orientation is top to
	 * bottom.
	 * 
