...
public class PFGraphable extends Graphable {
	...
	/**
	 * Associate the given X value with the given data. This function is used to
	 * "load" up the graphable with data.
	 *
	 * @param x      the x value
	 ...
	 *
	 * @param value The box price which represents the smallest plottable price
	 *              point
	 */
	...
	/**
	 * Set the size of the date column span. A PF graph does not necessarily have
	 * price data for a particular date.
	 * 
	...
	/**
	 * Associate the given X value with the given Y value. This function is used to
	 * "load" up the graphable with data.
	 *
	 * @param x the x value
	 * @param y the y value
	...
	/**
	 * Associate the given x value with the given character. This function is used
	 * to "load" up the graphable with data.
	 *
	 * @param x the x value
	 ...
	 *
	 * @param xRange a <code>List</code> of <code>Comparable</code> objects
