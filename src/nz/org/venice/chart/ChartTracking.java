...
public class ChartTracking implements IModuleListener {
	 ...
	 * @param table       The TrackedQuoteModule which displays the quote under the
	 *                    cursor.
	...
	/**
	 * When a new row in the table is selected, move the tracker to the quote at the
	 * selected position.
	 * 
	...
	/**
	 * Listen for when the quotemodule or chart module are closed so that either the
	 * tracker can be removed or the quote module closed.
	 * 
