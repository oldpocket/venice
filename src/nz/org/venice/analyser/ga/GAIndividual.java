...
/**
 * A trading individual evolved by the GA. The Individual contains a set of
 * parameters for the buy rule and the sell rule.
 */
public class GAIndividual {
	...
	/**
	 * Randomly generate an individual using two individuals as highest and lowest
	 ...
	 */
	public GAIndividual(Random random, GAIndividual mother, GAIndividual father, GAIndividual lowest,
