...
public class GPResult {
	...
	public GPResult(Individual individual, EODQuoteBundle quoteBundle, Money initialCapital, Money tradeCost,
			int generation, TradingDate startDate, TradingDate endDate) {
