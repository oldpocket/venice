...
public class GAResultModule extends AbstractTable implements IModule {
	...
	private List createColumns() {
		...
		columns.add(new Column(START_DATE_COLUMN, Locale.getString("START_DATE"),
				Locale.getString("START_DATE_COLUMN_HEADER"), TradingDate.class, Column.HIDDEN));
		columns.add(new Column(END_DATE_COLUMN, Locale.getString("END_DATE"),
				Locale.getString("END_DATE_COLUMN_HEADER"), TradingDate.class, Column.HIDDEN));
		...
		columns.add(new Column(GENERATION_COLUMN, Locale.getString("GENERATION_NUMBER"),
				Locale.getString("GENERATION_NUMBER_COLUMN_HEADER"), Integer.class, Column.VISIBLE));
		columns.add(new Column(INITIAL_CAPITAL_COLUMN, Locale.getString("INITIAL_CAPITAL"),
				Locale.getString("INITIAL_CAPITAL_COLUMN_HEADER"), Money.class, Column.HIDDEN));
	...
	public String getTitle() {
		return Locale.getString("GENETIC_ALGORITHM_RESULTS_TITLE");
	}
