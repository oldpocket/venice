 ...
 *
 * The main principles of this time class are speed (as fast as possible) and
 * size (as small as possible). It produces a much smaller and faster time class
 * than using the Calendar hierarchy.
 *
...
public class TradingTime implements Cloneable, Comparable {
	...
	/*
	 * Create a new time from the given string. We can parse the following time
	 * strings: <p> <table> <tr><td><pre>HH:MM</pre></td><td>e.g. "16:02"</td></tr>
	 * <tr><td><pre>HH:MM:SS</pre></td><td>e.g. "16:02:00"</td></tr>
	 * <tr><td><pre>H:MMAP</pre></td><td>e.g. "4:02pm"</td></tr>
	 * <tr><td><pre>HH:MMAP</pre></td><td>e.g. "04:02pm"</td></tr> </table>
	 *
	 * @param time the time string to parse
	 * 
	 * @exception TradingTimeException if the time couldn't be parsed
	 */
	public TradingTime(String time) throws TradingTimeFormatException {
	 ...
	 *
	 * @param time the specified time to compare
	 * @return <code>true</code> if the specified time is equal; <code>false</code>
	 *         otherwise.
	 */
	 ...
	 * @return the value <code>0</code> if the times are equal; <code>1</code> if
	 *         this time is after the specified time or <code>-1</code> if this time
	...
	public int diff(TradingTime time) {
		return (time.getHour() - getHour()) * MINUTES_IN_HOUR * SECONDS_IN_MINUTE
				+ (time.getMinute() - getMinute()) * SECONDS_IN_MINUTE + (time.getSecond() - getSecond());
	}
	...
	public String toString() {
		return (getNumberFormat().format(getHour()) + ":" + getNumberFormat().format(getMinute()) + ":"
				+ getNumberFormat().format(getSecond()));
	}

	/**
	 * Return the format suitable for displaying the minute and second fields.
	 *
