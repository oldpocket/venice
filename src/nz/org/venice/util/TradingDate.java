 ...
 *
 * The main principles of this date class are speed (as fast as possible) and
 * size (as small as possible). It produces a much smaller and faster date class
 * than using the Calendar hierarchy. It also beats java.util.Date 7 * by not
...
public class TradingDate implements Cloneable, Comparable {
	...
	/**
	 * Date format will be in US format, e.g. <code>mm/dd/yy</code>,
	 * <code>mm/dd/yyyy</code> etc.
	 */
	public final static int US = 0;

	/**
	 * Date format will be in britsh format, e.g. <code>dd/mm/yy</code>,
	 * <code>dd/mm/yyyy</code> etc.
	 */
	...
	/**
	 * Create a new date from the given string. We can parse the following date
	 * strings:
	 * <p>
	 * <table>
	 * <tr>
	...
	public TradingDate(String date, int type) throws TradingDateFormatException {
		...
		try {
			...
			if (isSeparator && date.length() == 10 && date.charAt(4) == separator && date.charAt(7) == separator) {
	 ...
	 *
	 * @param date the specified date to compare
	 * @return <code>true</code> if the specified date is equal; <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Create a new date which is the specified number of trading days before this
	 * date.
	 *
	...
	/**
	 * Create a new date which is the specified number of trading days after this
	 * date.
	 *
	 * @param days the number of days to move
	...
	private TradingDate weekendShift(TradingDate date, boolean forwardDirection) {
	 ...
	 * @return the value <code>0</code> if the dates are equal; <code>1</code> if
	 *         this date is after the specified date or <code>-1</code> if this date
	...
	/**
	 * Convert date to string in specified format. Will convert the date to a string
	 * matching the given format. The following substitutions will be made:
	 * <p>
	 * <table>
	 * <tr>
	 * <td>
	 ...
	 * 
	 * </td>
	 * <td>Replaced with one or two digit day</td>
	 * </tr>
	 * <tr>
	 * <td>
	 * 
	 ...
	 * 
	 * </td>
	 * <td>Replaced with two digit day</td>
	 * </tr>
	 * <tr>
	 * <td>
	 * 
	 ...
	 * 
	 * </td>
	 * <td>Replaced with one or two digit month</td>
	 * </tr>
	 * <tr>
	 * <td>
	 * 
	 ...
	 * 
	 * </td>
	 * <td>Replaced with two digit month</td>
	 * </tr>
	 * <tr>
	 * <td>
	 * 
	 ...
	 * 
	 * </td>
	 * <td>Replaced with 3 letter month name</td>
	 * </tr>
	 * <tr>
	 * <td>
	 * 
	 ...
	 * 
	 * </td>
	 * <td>Replaced with two digit year</td>
	 * </tr>
	 * <tr>
	 * <td>
	 * 
	 ...
	 * 
	 * </td>
	 * <td>Replaced with four digit year</td>
	 * </tr>
	 * </table>
	 * <p>
	 * E.g.:
	...
	public String toString(String format) {
		...
		format = Find.replaceAll(format, "mm", Converter.toFixedString(getMonth(), 2));

		format = Find.replaceAll(format, "MMM", monthToText(getMonth()));
		format = Find.replaceAll(format, "yyyy", Converter.toFixedString(getYear(), 4));

		if (getYear() > 99) {
			format = Find.replaceAll(format, "yy", Integer.toString(getYear()).substring(2));
		} else {
			format = Find.replaceAll(format, "yy", Integer.toString(getYear()));
		}
	...
	public String toLongString() {
		return getDay() + " " + monthToText(getMonth()) + ", " + getYear();
	}
	...
	public static String monthToText(int month) {
		String months[] = { Locale.getString("JAN"), Locale.getString("FEB"), Locale.getString("MAR"),
				Locale.getString("APR"), Locale.getString("MAY"), Locale.getString("JUN"), Locale.getString("JUL"),
				Locale.getString("AUG"), Locale.getString("SEP"), Locale.getString("OCT"), Locale.getString("NOV"),
	...
	private static int textToMonth(String monthString) {
		...
		// language.
		String months[][] = { { "jan", "january", "janvier", "enero", "januar", "gennaio", "januari" },
				{ "feb", "february", "f\351vrier", "febrero", "februar", "febbraio", "februari" },
				{ "mar", "march", "mars", "marzo", "marts", "m\344rz", "marzo" },
				{ "apr", "april", "avril", "abril", "aprile" }, { "may", "mai", "mayo", "maj", "maggio" },
	...
	/**
	 * Converts a two digit year to four digit year. The year 0 to 30 are
	 * transformed to 2000 to 2030 respecitvely; the years 31 to 99 to 1931 and 1999
	 * respectively.
	 *
	...
	public static List dateRangeToList(TradingDate startDate, TradingDate endDate) {
		assert (startDate != null && endDate != null && startDate.compareTo(endDate) <= 0);
