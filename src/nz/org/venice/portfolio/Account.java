...
/**
 * Generic interface for all financial account objects. This interface defines
 * some generic properties that all accounts need to have such as name, type and
 * value.
 *
