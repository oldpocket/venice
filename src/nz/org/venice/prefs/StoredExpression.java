...
/**
 * A representation of an expression that can be referenced by name. A stored
 * expression is saved in the Preferences data so that the user does not have to
