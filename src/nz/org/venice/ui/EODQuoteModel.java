...
/**
 * Table model to display end of day quotes to the user. This model tells a
 * table how to display end of day quotes by describing the columns and how to
 * populate the table with quotes from a quote bundle.
 *
...
public class EODQuoteModel extends AbstractQuoteModel {
	 ...
	 * @param quotes        A list of {@link EODQuote} which contain the quote
	 *                      symbols and dates to table.
	 ...
	 *                      {@link Column#VISIBLE} or {@link Column#ALWAYS_HIDDEN}.
	 */
	public EODQuoteModel(EODQuoteBundle quoteBundle, List quotes, int displayDate, int displaySymbol) {
		super(quoteBundle, quotes, ACTIVITY_COLUMN + 1);

		this.quoteBundle = quoteBundle;

		List columns = new ArrayList();
		columns.add(new Column(SYMBOL_COLUMN, Locale.getString("SYMBOL"), Locale.getString("SYMBOL_COLUMN_HEADER"),
		...
		columns.add(new Column(VOLUME_COLUMN, Locale.getString("VOLUME"), Locale.getString("VOLUME_COLUMN_HEADER"),
				Long.class, Column.VISIBLE));
		columns.add(new Column(DAY_LOW_COLUMN, Locale.getString("DAY_LOW"), Locale.getString("DAY_LOW_COLUMN_HEADER"),
				QuoteFormat.class, Column.VISIBLE));
		columns.add(new Column(DAY_HIGH_COLUMN, Locale.getString("DAY_HIGH"),
				Locale.getString("DAY_HIGH_COLUMN_HEADER"), QuoteFormat.class, Column.VISIBLE));
		columns.add(new Column(DAY_OPEN_COLUMN, Locale.getString("DAY_OPEN"),
				Locale.getString("DAY_OPEN_COLUMN_HEADER"), QuoteFormat.class, Column.VISIBLE));
		columns.add(new Column(DAY_CLOSE_COLUMN, Locale.getString("DAY_CLOSE"),
				Locale.getString("DAY_CLOSE_COLUMN_HEADER"), QuoteFormat.class, Column.VISIBLE));
		columns.add(new Column(POINT_CHANGE_COLUMN, Locale.getString("POINT_CHANGE"),
				Locale.getString("POINT_CHANGE_COLUMN_HEADER"), PointChangeFormat.class, Column.HIDDEN));
		...
		columns.add(new Column(ACTIVITY_COLUMN, Locale.getString("ACTIVITY"),
				Locale.getString("ACTIVITY_COLUMN_HEADER"), Integer.class, Column.ALWAYS_HIDDEN));
		setColumns(columns);
	}
