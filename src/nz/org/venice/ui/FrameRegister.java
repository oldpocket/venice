...
/**
 *
 * FrameRegister is a collection of ModuleFrames. It is an implementation of a
 * simple monitor and it's purpose is to serialise the creation of new
 * ModuleFrames.
 *
 * FrameRegister was written initially for the purpose of restoring saved
 * windows as a way of accessing the new ModuleFrame objects but also as a way
 ...
 * made to serialise their creation under restoration rather than attempt to
 * modify code that otherwise works perfectly well.
 * 
...
/*
 * For some reason, creation of multiple ChartModules isn't a problem anymore,
 ...
 * Further, a general key is necessary for the frame to remove itself from the
 * register.
 */
...
public class FrameRegister extends HashMap {
	 ...
	 * 
	 * The method will block if there is no ModuleFrame associated with the key.
	 * 
