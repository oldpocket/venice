...
/**
 * Replacement dialog for Java's JOptionPane dialog for querying the user to
 * enter a text field. It provides two fixes for the existing Java code.
 *
 * Firstly it allows for default text to be placed in the text input field,
 * secondly it allows the user to press return to exit the dialog.
 *
...
public class TextDialog implements ActionListener {
	 ...
	 */
	public TextDialog(JComponent parent, String message, String title, String defaultText) {
		newDialog(parent, message, title, defaultText);
	}

	// Create a new text dialog
	private void newDialog(JComponent parent, String message, String title, String defaultText) {
