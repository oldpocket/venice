...
public class ExpressionDialog implements ActionListener {
	// TODO: Merge expression query code into this module and delete
	// ExpressionQuery.
	 ...
	 * @param message           The question to ask the user
	 * @param title             The title to place on the dialog
	 * @param defaultExpression The default expression to display in the expression
	 *                          ComboBox
	 */
	public ExpressionDialog(JComponent parent, String message, String title, String defaultExpression) {
		newDialog(parent, message, title, defaultExpression);
	}

	// Create a new expression dialog
	private void newDialog(JComponent parent, String message, String title, String defaultExpression) {
		this.parent = parent;
