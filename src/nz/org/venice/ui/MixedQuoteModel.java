 ...
 * user. This model tells a table how to display the quotes by describing the
 * columns and how to populate the table with quotes using data from a quote
 * bundle.
 *
...
public class MixedQuoteModel extends AbstractQuoteModel {
	...
	public MixedQuoteModel(IQuoteBundle quoteBundle, List quotes, int displayDate, int displaySymbol) {
		...
		columns.add(new Column(TIME_COLUMN, Locale.getString("TIME"), Locale.getString("TIME_COLUMN_HEADER"),
				Symbol.class, Column.HIDDEN));
		columns.add(new Column(LAST_COLUMN, Locale.getString("LAST"), Locale.getString("LAST_COLUMN_HEADER"),
		...
		columns.add(new Column(BID_COLUMN, Locale.getString("BID"), Locale.getString("BID_COLUMN_HEADER"),
				QuoteFormat.class, Column.HIDDEN));
		columns.add(new Column(ASK_COLUMN, Locale.getString("ASK"), Locale.getString("ASK_COLUMN_HEADER"),
				QuoteFormat.class, Column.HIDDEN));
