 ...
 * Using GridBagLayout and this class you can easily create forms, reducing code
 * repeitition. For example to create a form which lets the user fill in two
 * text field entries:
 * 
 * <pre>
 ...
 * 
 * JTextField initialCapitalTextField = GridBagHelper.addTextRow(formPanel, "Initial Capital", "", gridbag, c, 10);
 * JTextField tradeCostTextField = GridBagHelper.addTextRow(formPanel, "Trade Cost", "", gridbag, c, 5);
 *
 * </pre>
 */
public class GridBagHelper {
	 ...
	 */
	public static JCheckBox addCheckBoxRow(JPanel panel, String field, boolean isSelected, GridBagLayout gridbag,
	 ...
	 * @return the check box
	 */
	public static JButton addButtonRow(JPanel panel, String field, GridBagLayout gridbag, GridBagConstraints c) {
	...
	public static JButton addHelpButtonRow(JPanel panel, String helpName, GridBagLayout gridbag, GridBagConstraints c) {
	 ...
	 */
	public static ExpressionComboBox addExpressionRow(JPanel panel, String field, String value, GridBagLayout gridbag,
			GridBagConstraints c) {
	 ...
	 */
	public static JPasswordField addPasswordRow(JPanel panel, String field, String value, GridBagLayout gridbag,
			GridBagConstraints c, int length) {
		JLabel label = new JLabel(field);
		c.gridwidth = 1;
		gridbag.setConstraints(label, c);
		panel.add(label);
	 ...
	 */
	public static JTextField addTextRow(JPanel panel, String field, String value, GridBagLayout gridbag,
			GridBagConstraints c, int length) {
		JLabel label = new JLabel(field);
		c.gridwidth = 1;
		gridbag.setConstraints(label, c);
	 ...
	 * @return the text field
	 */
	public static JTextField addTextRow(JPanel panel, JLabel label, String value, GridBagLayout gridbag,
			GridBagConstraints c, int length) {
		c.gridwidth = 1;
		gridbag.setConstraints(label, c);
		panel.add(label);
	 ...
	 */
	public static JLabel addLabelRow(JPanel panel, String field, String labelText, GridBagLayout gridbag,
			GridBagConstraints c) {
	 ...
	 */
	public static SymbolListComboBox addSymbolListComboBox(JPanel panel, String field, String symbolList,
	 ...
	 * @return the symbol list combo box
	 */
	public static JComboBox addComboBox(JPanel panel, String field, Vector list, GridBagLayout gridbag,
			GridBagConstraints c) {
	...
	public static JPanel addPanel(JPanel panel, String field, GridBagLayout gridbag, GridBagConstraints c) {
	...
	public static JPanel addPanel(JPanel panel, String field, JPanel sourcepanel, GridBagLayout gridbag,
			GridBagConstraints c) {
