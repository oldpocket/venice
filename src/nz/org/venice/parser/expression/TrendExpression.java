...
public class TrendExpression extends TernaryExpression {
	 ...
	 */
	public TrendExpression(IExpression quote, IExpression days, IExpression lag) {
	...
	public Object clone() {
		return new TrendExpression((IExpression) getChild(0).clone(), (IExpression) getChild(1).clone(),
