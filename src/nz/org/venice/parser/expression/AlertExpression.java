...
/**
 * An no op expression which when evaluated displays a message. For debugging
 * rules.
 *
 * @author Mark Hummel
 */
...
public class AlertExpression extends UnaryExpression {
	...
	public double evaluate(Variables variables, IQuoteBundle quoteBundle, Symbol symbol, int day)
		...
		JOptionPane.showMessageDialog(null, message, Locale.getString("ALERT_TITLE"), JOptionPane.INFORMATION_MESSAGE);
