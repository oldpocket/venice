...
public class AvgExpression extends TernaryExpression {
	 ...
	 */
	public AvgExpression(IExpression quote, IExpression days, IExpression lag) {
	...
	public String toString() {
		...
		return new String("avg(" + c1 + ", " + c2 + ", " + c3 + ")");
	}
	...
	public int checkType() throws TypeMismatchException {
		...
		if ((getChild(0).checkType() == FLOAT_QUOTE_TYPE || getChild(0).checkType() == INTEGER_QUOTE_TYPE)
				&& (getChild(1).checkType() == INTEGER_TYPE || getChild(1).checkType() == FLOAT_TYPE)
				&& (getChild(2).checkType() == INTEGER_TYPE || getChild(2).checkType() == FLOAT_TYPE))
			return getType();
		else {
	...
	public Object clone() {
		return new AvgExpression((IExpression) getChild(0).clone(), (IExpression) getChild(1).clone(),
