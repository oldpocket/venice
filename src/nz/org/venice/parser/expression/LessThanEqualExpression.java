...
public class LessThanEqualExpression extends ComparisionExpression {
	...
	public LessThanEqualExpression(IExpression left, IExpression right) {
		super(left, right);
	}
	...
	public Object clone() {
		return new LessThanEqualExpression((IExpression) getChild(0).clone(), (IExpression) getChild(1).clone());
	}
}
