...
/**
 * An expression which finds the standard deviation of a quote over a given
 * trading period.
 *
...
public class StandardDeviationExpression extends TernaryExpression {
	...
	/**
	 * Create a new standard deviation expression for the given <code>quote</code>
	 ...
	 */
	public StandardDeviationExpression(IExpression quote, IExpression days, IExpression lag) {
	...
	public Object clone() {
		return new StandardDeviationExpression((IExpression) getChild(0).clone(), (IExpression) getChild(1).clone(),
