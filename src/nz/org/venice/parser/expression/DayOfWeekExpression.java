...
/**
 * A function that returns the current day of week. The first day of the week
 * depends on the locale. In the U.S it starts on Sunday, in France it starts on
 * Monday. The first day of the week will be 1.
 */
