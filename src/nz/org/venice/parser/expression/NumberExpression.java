...
public class NumberExpression extends TerminalExpression {
	...
	public boolean equals(Object object) {
		if (object instanceof NumberExpression) {
			...
			if (expression.getValue() == getValue() && expression.getType() == getType())
				return true;
		}
	...
	/**
	 * Returns whether the given expression is a NumberExpression set to the given
	 * constant. This is a convenience method often called when printing functions
	 * to determine whether the print should print only an abbreviated form, e.g.
	 *
	 ...
	 *
	 * @return one of {@link #BOOLEAN_TYPE}, {@link #FLOAT_TYPE} or
	 *         {@link #INTEGER_TYPE}.
	 */
	public int getType() {
		return type;
