...
public class MinExpression extends TernaryExpression {
	...
	/**
	 * Create a new minimum expression for the given <code>quote</code> kind, for
	...
	public String toString() {
		...
		return new String("min(" + c1 + ", " + c2 + ", " + c3 + ")");
	}
	...
	private double min(QuoteBundle quoteBundle, Symbol symbol, int quote, int days, int day, int offset)
		...
		/*
		 * Returning Double.MAX_VALUE here causes offset to overflow when the parent is
