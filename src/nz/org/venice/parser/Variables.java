...
public class Variables {
	...
	/**
	 * Add a new variable. The variable will be initialised to zero if numeric or
	 * <code>FALSE</code> if boolean.
	 * 
	 ...
	 * @param type       the type of the variable.
	 * @param isConstant set to <code>TRUE</code> if the variable is a constant.
	 * @param isFunction set to <code>TRUE</code> if the variable is a function.
	 * @param value      the initial value.
	 */
	...
	/**
	 * Compare the two sets of variables and return any differences. A difference is
	 * any two variables with the same name but different values or any variables
	 * which exist in the first set, but not the second and vice versa.
	 * 
