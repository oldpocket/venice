...
public class Token {
	...
	/** Represents "<code>floor</code> symbol */
	public static final int FLOOR_TOKEN = 68;
	...
	/** Represents "<code>offsetExists</code> symbol. */
	public static final int DATACHECK_TOKEN = 71;

	// Number of fixed length tokens, i.e. the ones above ^^
	private static final int FIXED_LENGTH_TOKENS = 72;
	...
	public static String[] wordsOfGondola() {
		...
		tokenStrings[DATACHECK_TOKEN] = "offsetExists";

		return tokenStrings;
	}

	/**
	 * Perform lexical analysis on the given string. Extract the first symbol found
	 * from the given string, set the passed token object to represent this symbol
	 * then return the given string sans the extracted symbol.
	 *
	 * @param variables variables that will be assumed to be defined for the
	 *                  equation
	...
	public static String stringToToken(Variables variables, Token token, String string) throws ParserException {
		...
		if (Character.isDigit(string.charAt(0))) {
			...
			} while (string.length() > 0 && (Character.isDigit(string.charAt(0)) || string.charAt(0) == '.'));
