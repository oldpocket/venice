...
import nz.org.venice.parser.expression.AlertExpression;
...
import nz.org.venice.parser.expression.CorrExpression;
import nz.org.venice.parser.expression.CosineExpression;
import nz.org.venice.parser.expression.DataCheckExpression;
...
import nz.org.venice.parser.expression.ForExpression;
...
import nz.org.venice.parser.expression.HaltExpression;
...
import nz.org.venice.parser.expression.LoggingExpression;
...
import nz.org.venice.parser.expression.QuoteSymbolExpression;
import nz.org.venice.parser.expression.RSIExpression;
import nz.org.venice.parser.expression.RandomWithSeedExpression;
import nz.org.venice.parser.expression.RandomWithoutSeedExpression;
...
public class ExpressionFactory {
	 ...
	 *
	 * @param token the unary expression, e.g. "<code>not(X)</code>"
	 ...
	 *
	 * @param token the binary expression, e.g. "<code>X and Y</code>"
	 * @param arg1  the first argument
	...
	public static Expression newExpression(Expression exp, Expression[] children) {
		...
		if (exp instanceof AndExpression) {
			...
			expression = new GetVariableExpression(((GetVariableExpression) exp).getName(),
					((GetVariableExpression) exp).getType());
