...
/**
 * An exception which is raised when invalid alert data is read. For example, if
 * the value for target price cannot be parsed as a double. Shouldn't happen,
 * but external processes could read/write alerts.
 *
 * @author Mark Hummel
 */
