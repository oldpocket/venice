...
public class FloatEODQuoteImport {
	...
	// Template for URL
	private final static String URL_PATTERN = ("http://float.com.au/download/_YEAR__MONTH__DAY_.txt");
	...
	public static List importDate(Report report, TradingDate date) throws ImportExportException {
		...
		IEODQuoteFilter filter = new MetaStockQuoteFilter();
	...
	/**
	 * Construct the URL necessary to retrieve all the quotes for the given date
	 * from float.com.au.
	 *
	...
	private static void verify(Report report, EODQuote quote) {
		try {
			...
			for (Iterator iterator = messages.iterator(); iterator.hasNext();) {
				...
				report.addWarning(Locale.getString("FLOAT_DISPLAY_URL") + ":" + quote.getSymbol() + ":"
