 ...
 * should create an instance of this class which represents all the task's
 * required quotes. This quote bundle is useful for displaying the latest value
 * of stock quotes. If intra-day quotes are not available, then user of this
 * package will transparently see just the end-of-day quotes. Even when
 * intra-day quotes are available, the end-of-day quotes can be used for
 * calculating quote change.
 * <p>
 * Example:
 * 
 * <pre>
...
public class MixedQuoteBundle implements IQuoteBundle {
	 ...
	 * between the two dates given and the current day's intra-day quotes. The quote
	 * bundle should be given at least two days of end of day quotes to properly
	 * calculate quote change, in case the intra-day quotes are not available.
	 *
	...
	/**
	 * Return whether we should display intra-day quotes or end of day quotes. This
	 * decision will be made solely on the basis of whether the intra-day quote sync
	 * is running. If we are not automatically downloading intra-day quotes, then
	 * display end of day quotes.
	 *
