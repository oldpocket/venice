...
public interface QuoteBundle {
	 ...
	 * specialised QuoteBundle implementations can prevent the GP accessing 'future'
	 * dates.
	 *
	 ...
	 *                  access time offset (see {@link IDQuoteCache}).
	 ...
	 * @exception MissingQuoteException if the quote was not found
	 */
	public double getQuote(Symbol symbol, int quoteType, int offset) throws MissingQuoteException;
	 ...
	 * @exception MissingQuoteException if the quote was not found
	 */
	public double getNearestQuote(Symbol symbol, int quoteType, int offset) throws MissingQuoteException;
	 ...
	 * return the same date for each offset because the offset refers to the time
	 * within that date. End-of-day quotes will return a different date for each
	 * fast access offset.
	 *
