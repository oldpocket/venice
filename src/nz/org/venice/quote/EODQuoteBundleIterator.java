 ...
 * the user to traverse each quote in any quote bundle. The quotes will be
 * pulled out in date then symbol order. To get an interator for a
 * EODQuoteBundle, use the {@link EODQuoteBundle#iterator} method.
 *
