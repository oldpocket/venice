...
/**
 * Returns the singleton reference to the quote source that the user has
 * selected in their preferences. This class will also be updated when the user
 * preferences has changed so the return quote source will always be update to
 * date.
 *
 * Example:
 * 
...
public class QuoteSourceManager {
	...
	/**
	 * Set the quote source to be the given quote source. This function was written
	 * for import. During import we set the quote source to be the source source for
	 * the import. Then after the import we flush the source and let it return to
	...
	/**
	 * Creates and returns singleton instance of quote source which user has
	 * selected in the Preferences->Quote Source page.
	 *
	 * @return quote source
	 */
