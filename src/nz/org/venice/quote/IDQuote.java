...
/**
 * Representation of an intra-day stock quote for a given stock, on a given day
 * at a given time.
 *
...
public class IDQuote implements IQuote {
	 ...
	 */
	public IDQuote(Symbol symbol, TradingDate date, TradingTime time, long currentVolume, double currentLow,
			double currentHigh, double dayOpen, double last, double bid, double ask) {
		setSymbol(symbol);
		setDate(date);
		setTime(time);
	 ...
	 * quote, such as the day low not being the lowest quote. This function does not
	...
	public String toString() {
		return new String(
				getSymbol() + ", " + getDate() + ", " + getTime() + ", " + QuoteFormat.quoteToString(getDayOpen())
						...
						+ QuoteFormat.quoteToString(getBid()) + ", " + QuoteFormat.quoteToString(getAsk()));
	}
}